...
Unlu, B., Wechsler, F., Pu, Y., & Moser, C. (2026). A unified multiscale 3D printer combining single-photon Tomographic Volumetric Additive Manufacturing and Two-Photon Polymerization. arXiv preprint arXiv:2601.13457.
`Preprint <https://arxiv.org/abs/2601.13457>`_.
...
2024
----
Nicolet, B., Wechsler, F., Madrid-Wolff, J., Moser, C., & Jakob, W. (2024). Inverse rendering for tomographic volumetric additive manufacturing. ACM Transactions on Graphics (TOG), 43(6), 1-17.
`Online Link <https://dl.acm.org/doi/abs/10.1145/3687924>`_.
